...
> below and
> [DR-018](../spec/decision-records/DR-018-por-hysteresis-quasi-static-scope.md).
...
`results.md` from the committed `logs/` without re-simulating.
