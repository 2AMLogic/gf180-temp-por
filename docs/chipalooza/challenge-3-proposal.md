...
This is the one section whose Evidence column is **not** reproduced by
`make characterize` (simulation-only, per the note above) — it is layout
evidence, regenerated by `bash layout/run_checks.sh` (README.md's "Layout
